 ...
 /****************************************************************/
 /* <BEGIN_BUILDINFO>                                            */
 /* Generated on:  27/11/19 09:43                                */
 /* Build Level:   p914-L191127.DE                               */
 ...
 const struct MQI_BY_VALUE_STR { 
  ...
  char *name;
   ...
   {         240, "MQCNO_CURRENT_LENGTH (4 byte)" },
   ...
   {         256, "MQCNO_CURRENT_LENGTH (8 byte)" },
 ...
 const struct MQI_BY_NAME_STR { 
  ...
  MQLONG value;
   ...
   {  "MQCNO_CURRENT_LENGTH (4 byte)"   ,        240 },
   {  "MQCNO_CURRENT_LENGTH (8 byte)"   ,        256 },
