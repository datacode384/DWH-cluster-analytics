...
# list all files - sudo -u hdfs hdfs dfs -ls / (or) hadoop fs -ls /
#reason for logging as hdfs user rather than root user - https://community.cloudera.com/t5/Support-Questions/hbase-user-iis-currently-not-available/m-p/15430
