...
def pas_tf_wrapper_core():
        key_obj = {
                "table_name": "pas_tf",
                "tenant_name": "r1i5v1",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_tf.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_tf",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"tf_id","fields":["tariffid"]},
								"sid":{"field_name":"tf_sid","fields":["process_id","tariffid"]}
                },
                "foreignKeys": {},
                "join_tables": []
        }
