...
def pas_vbext_wrapper_core():
        key_obj = {
                "table_name": "pas_vbext",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_vbext.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_vbext",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_vb_id","fields":["lvid","vbid","vtid"]},
								"sid":{"field_name":"pas_vbext_sid","fields":["bearbidabg","lvid","process_id","vbid","vtid"]}
                },
