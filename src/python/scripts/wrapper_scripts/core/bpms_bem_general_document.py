...
def load_bpms_bem_general_document():
	key_obj = {"application_name": "DWH",
		"source_database" : "raw_zone",
		"source_table" : "bpms_bem_l0_dwh_in_1",
		"target_database" : "core",
		"target_table" : "bpms_bem_general_document",
		"target_key_table" : "key_bpms_bem_general_document",
		"tenant_name": "@@@TENANT@@@",
		"source_system" : "201",
		"join_tables" : [@@@TABLE_JOINS@@@],
		"message_filter" : "{'GENERAL_DOCUMENT_ID', 'GENERAL_DOCUMENT_TYPE', 'PROTECTION_CLASS', 'RETENTION_TYPE'}",
		"primaryKeys": { @@@KEY_TYPE_ID@@@, @@@KEY_TYPE_SID@@@ },
...
if __name__ == "__main__":
	load_bpms_bem_general_document()
