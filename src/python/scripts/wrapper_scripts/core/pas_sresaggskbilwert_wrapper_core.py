...
def pas_sresaggskbilwert_wrapper_core():
        key_obj = {
                "table_name": "pas_sresaggskbilwert",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_sresaggskbilwert.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_sresaggskbilwert",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_sres_id","fields":["lvid"]},
								"sid":{"field_name":"pas_sresaggskbilwert_sid","fields":["lvid","process_id"]}
                },
                "foreignKeys": {"pas_lv_id":["lvid"]},
                "join_tables": [{"join_schema":"core","joined_table":"ref_tpa_mandant","join_columns":["mandantid"],"new_columns":[["tpa_mandant","tpa_mandant"]],"join_type":"left_outer"}]
        }
...
if __name__ == "__main__":
	pas_sresaggskbilwert_wrapper_core()