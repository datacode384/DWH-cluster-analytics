...
def pas_vtta_wrapper_core():
        key_obj = {
                "table_name": "pas_vtta",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_vtta.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_vtta",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_vtta_id","fields":["lvid","tadat","vtid"]},
								"sid":{"field_name":"pas_vtta_sid","fields":["bearbidabg","lvid","process_id","tadat","vtid"]}
                },
