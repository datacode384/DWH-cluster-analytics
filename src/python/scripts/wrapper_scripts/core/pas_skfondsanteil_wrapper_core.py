...
def pas_skfondsanteil_wrapper_core():
        key_obj = {
                "table_name": "pas_skfondsanteil",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_skfondsanteil.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_skfondsanteil",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_skfondsanteil_id","fields":["fondsid","lvid","varianteid","vtid"]},
								"sid":{"field_name":"pas_skfondsanteil_sid","fields":["bearbidabg","fondsid","lvid","process_id","varianteid","vtid"]}
                },
...
if __name__ == "__main__":
	pas_skfondsanteil_wrapper_core()