...
def pas_versausgl_wrapper_core():
        key_obj = {
                "table_name": "pas_versausgl",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_versausgl.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_versausgl",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_versausgl_id","fields":["ehezeitbeg","hvgruppeid","lvid"]},
								"sid":{"field_name":"pas_versausgl_sid","fields":["bearbidabg","ehezeitbeg","hvgruppeid","lvid","process_id"]}
                },
