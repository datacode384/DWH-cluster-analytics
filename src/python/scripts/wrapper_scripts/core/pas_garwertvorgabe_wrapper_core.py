...
def pas_garwertvorgabe_wrapper_core():
        key_obj = {
                "table_name": "pas_garwertvorgabe",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_garwertvorgabe.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_garwertvorgabe",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_garwertvorgabe_id","fields":["guetermin","lvid","vbid","vtid"]},
								"sid":{"field_name":"pas_garwertvorgabe_sid","fields":["bearbidabg","guetermin","lvid","process_id","vbid","vtid"]}
                },
...
if __name__ == "__main__":
	pas_garwertvorgabe_wrapper_core()