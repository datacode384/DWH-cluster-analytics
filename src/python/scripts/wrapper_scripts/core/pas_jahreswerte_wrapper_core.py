...
def pas_jahreswerte_wrapper_core():
        key_obj = {
                "table_name": "pas_jahreswerte",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_jahreswerte.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_jahreswerte",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_jahreswerte_id","fields":["jahr","lvid","vtid"]},
								"sid":{"field_name":"pas_jahreswerte_sid","fields":["bearbidabg","jahr","lvid","process_id","vtid"]}
                },
