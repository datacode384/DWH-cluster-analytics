...
def pas_vbuebverw_wrapper_core():
        key_obj = {
                "table_name": "pas_vbuebverw",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_vbuebverw.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_vbuebverw",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_vbuebverw_id","fields":["lvid","vbid","vsys","vtid"]},
								"sid":{"field_name":"pas_vbuebverw_sid","fields":["bearbidabg","lvid","process_id","vbid","vsys","vtid"]}
                },
