...
def pas_notiz_wrapper_core():
        key_obj = {
                "table_name": "pas_notiz",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_notiz.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_notiz",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_notiz_id","fields":["kontextid","lvid"]},
								"sid":{"field_name":"pas_notiz_sid","fields":["bearbidabg","kontextid","lvid","process_id"]}
                },
