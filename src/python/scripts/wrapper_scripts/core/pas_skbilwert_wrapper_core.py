...
def pas_skbilwert_wrapper_core():
        key_obj = {
                "table_name": "pas_skbilwert",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_skbilwert.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_skbilwert",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_sammel_kto_id","fields":["lvid","varianteid","vtid"]},
								"sid":{"field_name":"pas_skbilwert_sid","fields":["bearbidabg","lvid","process_id","varianteid","vtid"]}
                },
