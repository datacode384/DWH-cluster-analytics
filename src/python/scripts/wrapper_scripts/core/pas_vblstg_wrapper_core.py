...
def pas_vblstg_wrapper_core():
        key_obj = {
                "table_name": "pas_vblstg",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_vblstg.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_vblstg",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_vblstg_id","fields":["lstgtyp","lvid","vbid","vtid"]},
								"sid":{"field_name":"pas_vblstg_sid","fields":["bearbidabg","lstgtyp","lvid","process_id","vbid","vtid"]}
                },
