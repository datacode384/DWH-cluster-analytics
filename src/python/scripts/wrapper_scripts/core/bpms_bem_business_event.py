...
def load_bpms_bem_business_event():
	key_obj = {"application_name": "DWH",
		"source_database" : "raw_zone",
		"source_table" : "bpms_bem_l0_dwh_in_1",
		"target_database" : "core",
		"target_table" : "bpms_bem_business_event",
		"target_key_table" : "key_bpms_bem_business_event",
		"tenant_name": "@@@TENANT@@@",
		"source_system" : "201",
		"join_tables" : [],
		"message_filter" : "{'BUSINESS_EVENT_ID', 'BUSINESS_EVENT_TYPE', 'BUSINESS_EVENT_STATUS', 'BUSINESS_EVENT_INPUT_CHANNEL_TYPE', 'GE_VO_ID'}",
		"primaryKeys": { "id":{"field_name":"bpms_bem_business_event_id","fields":["business_event_id"]}, "sid":{"field_name":"bpms_bem_business_event_sid","fields":["business_event_id","jms_message_id","process_id"]} },
		"foreignKeys": { }
	}
	spark = spark_init()
