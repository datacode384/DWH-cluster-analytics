...
def pas_partnerlv_wrapper_core():
        key_obj = {
                "table_name": "pas_partnerlv",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_partnerlv.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_partnerlv",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_vp_id","fields":["lvid","partnerid","rollenid"]},
								"sid":{"field_name":"pas_partnerlv_sid","fields":["bearbidabg","lvid","partnerid","process_id","rollenid"]}
                },
