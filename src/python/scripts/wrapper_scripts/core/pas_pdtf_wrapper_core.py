...
def pas_pdtf_wrapper_core():
        key_obj = {
                "table_name": "pas_pdtf",
                "tenant_name": "r1i5v1",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_pdtf.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_pdtf",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pdtf_id","fields":["productid","tariffid"]},
								"sid":{"field_name":"pdtf_sid","fields":["process_id","productid","tariffid"]}
                },
                "foreignKeys": {},
                "join_tables": []
        }
