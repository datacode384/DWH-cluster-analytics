...
def pas_zahlempfdat_wrapper_core():
        key_obj = {
                "table_name": "pas_zahlempfdat",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_zahlempfdat.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_zahlempfdat",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_zahlempfdat_id","fields":["lvid","zahlempfid"]},
								"sid":{"field_name":"pas_zahlempfdat_sid","fields":["bearbidabg","lvid","process_id","zahlempfid"]}
                },
