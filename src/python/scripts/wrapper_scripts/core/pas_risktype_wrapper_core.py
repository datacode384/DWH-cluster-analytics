...
def pas_risktype_wrapper_core():
        key_obj = {
                "table_name": "pas_risktype",
                "tenant_name": "r1i5v1",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_risktype.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_risktype",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"risktype_id","fields":["rismerk"]},
								"sid":{"field_name":"risktype_sid","fields":["process_id","rismerk"]}
                },
                "foreignKeys": {},
                "join_tables": []
        }
