...
def pas_sntvt_wrapper_core():
        key_obj = {
                "table_name": "pas_sntvt",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_sntvt.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_sntvt",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_sntvt_id","fields":["lvid","vtid"]},
								"sid":{"field_name":"pas_sntvt_sid","fields":["bearbid","bearbidref","lvid","process_id","vtid"]}
                },
