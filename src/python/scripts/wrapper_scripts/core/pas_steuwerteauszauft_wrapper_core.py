...
def pas_steuwerteauszauft_wrapper_core():
        key_obj = {
                "table_name": "pas_steuwerteauszauft",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_steuwerteauszauft.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_steuwerteauszauft",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_steuwerteauszauft_id","fields":["beitragstyp","lvid","schichtid","vtid"]},
								"sid":{"field_name":"pas_steuwerteauszauft_sid","fields":["bearbidabg","bearbidref","beitragstyp","lvid","process_id","schichtid","vtid"]}
                },
...
if __name__ == "__main__":
	pas_steuwerteauszauft_wrapper_core()