...
def load_bpms_bem_e2e_process():
	key_obj = {"application_name": "DWH",
		"source_database" : "raw_zone",
		"source_table" : "bpms_bem_l0_dwh_in_1",
		"target_database" : "core",
		"target_table" : "bpms_bem_e2e_process",
		"target_key_table" : "key_bpms_bem_e2e_process",
		"tenant_name": "@@@TENANT@@@",
		"source_system" : "201",
		"join_tables" : [@@@TABLE_JOINS@@@],
		"message_filter" : "{'E2E_PROCESS_ID' ,'E2E_PROCESS_STATUS'}",
		"primaryKeys": { "id":{"field_name":"bpms_bem_e2e_process_id","fields":["e2e_process_id"]}, "sid":{"field_name":"bpms_bem_e2e_process_sid","fields":["e2e_process_id","jms_message_id","process_id"]} },
