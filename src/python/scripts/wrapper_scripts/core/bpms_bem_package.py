...
def load_bpms_bem_package():
	key_obj = {"application_name": "DWH",
		"source_database" : "raw_zone",
		"source_table" : "bpms_bem_l0_dwh_in_1",
		"target_database" : "core",
		"target_table" : "bpms_bem_package",
		"target_key_table" : "key_bpms_bem_package",
		"tenant_name": "@@@TENANT@@@",
		"source_system" : "201",
		"join_tables" : [@@@TABLE_JOINS@@@],
		"message_filter" : "{'FETCH_TIMESTAMP' ,'PACKAGE_ID' ,'PACKAGE_STATUS'}",
		"primaryKeys": { "id":{"field_name":"bpms_bem_package_id","fields":["external_package_correlation_id","package_id"]}, "sid":{"field_name":"bpms_bem_package_sid","fields":["external_package_correlation_id","jms_message_id","package_id","process_id"]} },
		"foreignKeys": { "bem_generic_id":["id"],"bpms_bem_package_entry_id":["external_correlation_id","package_entry_id"],"bpms_bem_package_entry_id":["external_correlation_id","package_entry_id"],"bpms_bem_package_entry_id":["external_correlation_id","package_entry_id"] }
	}
	spark = spark_init()
