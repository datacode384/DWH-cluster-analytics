...
def pas_steuschicht_wrapper_core():
        key_obj = {
                "table_name": "pas_steuschicht",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_steuschicht.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_steuschicht",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_steuschicht_id","fields":["lvid","schichtid","vtid"]},
								"sid":{"field_name":"pas_steuschicht_sid","fields":["bearbidabg","lvid","process_id","schichtid","vtid"]}
                },
