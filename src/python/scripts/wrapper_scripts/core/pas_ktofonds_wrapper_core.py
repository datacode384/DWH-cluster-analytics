...
def pas_ktofonds_wrapper_core():
        key_obj = {
                "table_name": "pas_ktofonds",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_ktofonds.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_ktofonds",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_ktofonds_id","fields":["ktobewid","ktostdtypid","lvid"]},
								"sid":{"field_name":"pas_ktofonds_sid","fields":["bearbid","ktobewid","ktostdtypid","lvid","process_id"]}
                },
