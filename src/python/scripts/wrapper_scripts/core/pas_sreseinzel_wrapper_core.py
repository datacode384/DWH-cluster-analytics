...
def pas_sreseinzel_wrapper_core():
        key_obj = {
                "table_name": "pas_sreseinzel",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_sreseinzel.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_sreseinzel",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_sres_id","fields":["lvid"]},
								"sid":{"field_name":"pas_sreseinzel_sid","fields":["lvid","process_id"]}
                },
