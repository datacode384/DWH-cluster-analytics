...
def load_bpms_bem_package_entry_envelope():
	key_obj = {"application_name": "DWH",
		"source_database" : "raw_zone",
		"source_table" : "bpms_bem_l0_dwh_in_1",
		"target_database" : "core",
		"target_table" : "bpms_bem_package_entry_envelope",
		"target_key_table" : "key_bpms_bem_package_entry_envelope",
		"tenant_name": "",
		"source_system" : "201",
		"join_tables" : [],
		"message_filter" : "{'ENVELOPE_ID' ,'SENDER_ID'}",
...
if __name__ == "__main__":
	load_bpms_bem_package_entry_envelope()
