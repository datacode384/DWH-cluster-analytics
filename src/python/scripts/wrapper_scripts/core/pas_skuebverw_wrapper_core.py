...
def pas_skuebverw_wrapper_core():
        key_obj = {
                "table_name": "pas_skuebverw",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_skuebverw.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_skuebverw",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_skuebverw_id","fields":["lvid","varianteid","vsys","vtid"]},
								"sid":{"field_name":"pas_skuebverw_sid","fields":["bearbidabg","lvid","process_id","varianteid","vsys","vtid"]}
                },
