...
def pas_vtpflege_wrapper_core():
        key_obj = {
                "table_name": "pas_vtpflege",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_vtpflege.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_vtpflege",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_vtpflege_id","fields":["lvid","partnerid","pflegestufe","rollenid","vtid"]},
								"sid":{"field_name":"pas_vtpflege_sid","fields":["bearbidabg","lvid","partnerid","pflegestufe","process_id","rollenid","vtid"]}
                },
