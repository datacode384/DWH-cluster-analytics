...
def pas_transparenz_wrapper_core():
        key_obj = {
                "table_name": "pas_transparenz",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_transparenz.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_transparenz",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_transparenz_id","fields":["infotyp","lvid","varianteid","vtid"]},
								"sid":{"field_name":"pas_transparenz_sid","fields":["bearbidabg","infotyp","lvid","process_id","varianteid","vtid"]}
                },
