...
def pas_steuauftreg_wrapper_core():
        key_obj = {
                "table_name": "pas_steuauftreg",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_steuauftreg.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_steuauftreg",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_steuauftreg_id","fields":["lvid","regid","vtid"]},
								"sid":{"field_name":"pas_steuauftreg_sid","fields":["bearbidabg","lvid","process_id","regid","vtid"]}
                },
