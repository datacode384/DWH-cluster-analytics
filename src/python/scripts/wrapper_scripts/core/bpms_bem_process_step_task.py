...
def load_bpms_bem_process_step_task():
	key_obj = {"application_name": "DWH",
		"source_database" : "raw_zone",
		"source_table" : "bpms_bem_l0_dwh_in_1",
		"target_database" : "core",
		"target_table" : "bpms_bem_process_step_task",
		"target_key_table" : "key_bpms_bem_process_step_task",
		"tenant_name": "@@@TENANT@@@",
		"source_system" : "201",
		"join_tables" : [@@@TABLE_JOINS@@@],
		"message_filter" : "{'BUSINESS_AREA' ,'PRIORITY_CLASS' ,'PROCESS_STEP_TYPE' ,'ROUTING_SKILL'}",
		"primaryKeys": { "id":{"field_name":"bpms_bem_process_step_id","fields":["general_process_step_id","process_step_type"]}, "sid":{"field_name":"bpms_bem_process_step_sid","fields":["general_process_step_id","jms_message_id","process_id","process_step_type"]} },
...
if __name__ == "__main__":
	load_bpms_bem_process_step_task()
