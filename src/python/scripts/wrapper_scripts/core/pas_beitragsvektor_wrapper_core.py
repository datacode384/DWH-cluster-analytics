...
def pas_beitragsvektor_wrapper_core():
        key_obj = {
                "table_name": "pas_beitragsvektor",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_beitragsvektor.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_beitragsvektor",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_beitragsvektor_id","fields":["btgtyp","jahr","lvid","monat","vtid"]},
								"sid":{"field_name":"pas_beitragsvektor_sid","fields":["bearbidabg","btgtyp","jahr","lvid","monat","process_id","vtid"]}
                },
...
if __name__ == "__main__":
	pas_beitragsvektor_wrapper_core()