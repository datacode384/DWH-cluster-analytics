...
def pas_abschlko_wrapper_core():
        key_obj = {
                "table_name": "pas_abschlko",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_abschlko.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_abschlko",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_abschlko_id","fields":["aktyp","beginn","jahr","lvid","monat","vbid","vtid"]},
								"sid":{"field_name":"pas_abschlko_sid","fields":["aktyp","bearbidabg","beginn","jahr","lvid","monat","process_id","vbid","vtid"]}
                },
                "foreignKeys": {"pas_vb_id":["lvid","vbid","vtid"]},
