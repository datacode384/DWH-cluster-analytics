...
def pas_jahrwerteinfofonds_wrapper_core():
        key_obj = {
                "table_name": "pas_jahrwerteinfofonds",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_jahrwerteinfofonds.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_jahrwerteinfofonds",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_jahrwerteinfofonds_id","fields":["fondsid","lvid","monat","vtid"]},
								"sid":{"field_name":"pas_jahrwerteinfofonds_sid","fields":["bearbidabg","fondsid","lvid","monat","process_id","vtid"]}
                },
...
if __name__ == "__main__":
	pas_jahrwerteinfofonds_wrapper_core()