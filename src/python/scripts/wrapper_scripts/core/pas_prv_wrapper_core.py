...
def pas_prv_wrapper_core():
        key_obj = {
                "table_name": "pas_prv",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_prv.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_prv",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_lv_id","fields":["agenturid","lvid","prvid"]},
								"sid":{"field_name":"pas_prv_sid","fields":["agenturid","bearbidabg","lvid","process_id","prvid"]}
                },
