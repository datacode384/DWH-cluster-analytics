...
def pas_hvgruppe_wrapper_core():
        key_obj = {
                "table_name": "pas_hvgruppe",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_hvgruppe.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_hvgruppe",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_hvgruppe_id","fields":["hvgruppeid","lvid"]},
								"sid":{"field_name":"pas_hvgruppe_sid","fields":["bearbid","bearbidabg","hvgruppeid","lvid","process_id"]}
                },
