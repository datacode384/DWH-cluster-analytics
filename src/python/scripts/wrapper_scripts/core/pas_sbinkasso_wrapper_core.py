...
def pas_sbinkasso_wrapper_core():
        key_obj = {
                "table_name": "pas_sbinkasso",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_sbinkasso.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_sbinkasso",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_anrewerte_id","fields":["lvid","sbid","varianteid","vtid"]},
								"sid":{"field_name":"pas_sbinkasso_sid","fields":["bearbid","lvid","process_id","sbid","varianteid","vtid"]}
                },
