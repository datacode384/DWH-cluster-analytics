...
def pas_steuwerte_wrapper_core():
        key_obj = {
                "table_name": "pas_steuwerte",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_steuwerte.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_steuwerte",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_steuwerte_id","fields":["aplanbearbrente","bezugsjahr","lvid","schichtid","vtid"]},
								"sid":{"field_name":"pas_steuwerte_sid","fields":["aplanbearbrente","bearbidabg","bezugsjahr","lvid","process_id","schichtid","vtid"]}
                },
