...
def pas_ktostd_wrapper_core():
        key_obj = {
                "table_name": "pas_ktostd",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_ktostd.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_ktostd",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_ktostd_id","fields":["fondsid","ktostdtypid","lvid","portfid","vbid","vtid"]},
								"sid":{"field_name":"pas_ktostd_sid","fields":["fondsid","ktostdtypid","lvid","portfid","process_id","vbid","vtid"]}
                },
                "foreignKeys": {},
