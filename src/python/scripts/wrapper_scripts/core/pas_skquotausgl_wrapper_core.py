...
def pas_skquotausgl_wrapper_core():
        key_obj = {
                "table_name": "pas_skquotausgl",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_skquotausgl.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_skquotausgl",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_skquotausgl_id","fields":["konspartid","lvid","quotausglproperty","varianteid","vtid"]},
								"sid":{"field_name":"pas_skquotausgl_sid","fields":["bearbidabg","konspartid","lvid","process_id","quotausglproperty","varianteid","vtid"]}
                },
                "foreignKeys": {"pas_vt_id":["lvid","vtid"]},
                "join_tables": [{"join_schema":"raw_zone","joined_table":"pas_bearbnw","join_columns":["bearbidabg","lvid"],"new_columns":[["wirkbeginn","wirksam_ab"],["bearbdat","gueltig_ab"]],"join_type":"inner"},{"join_schema":"core","joined_table":"ref_tpa_mandant","join_columns":["mandantid"],"new_columns":[["tpa_mandant","tpa_mandant"]],"join_type":"left_outer"}]
        }
