...
def pas_steuwertestand_wrapper_core():
        key_obj = {
                ...
                "primaryKeys": { "id":{"field_name":"pas_steuschicht_id","fields":["lvid","schichtid","vtid"]},
								"sid":{"field_name":"pas_steuwertestand_sid","fields":["bearbidabg","lvid","process_id","schichtid","vtid"]}
                },
...
if __name__ == "__main__":
	pas_steuwertestand_wrapper_core()