...
def pas_transparenzgarko_wrapper_core():
        key_obj = {
                "table_name": "pas_transparenzgarko",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_transparenzgarko.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_transparenzgarko",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_transparenzgarko_id","fields":["lfdnr","lvid","varianteid","vtid"]},
								"sid":{"field_name":"pas_transparenzgarko_sid","fields":["bearbidabg","lfdnr","lvid","process_id","varianteid","vtid"]}
                },
...
if __name__ == "__main__":
	pas_transparenzgarko_wrapper_core()