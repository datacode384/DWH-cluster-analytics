...
def pas_beguenst_wrapper_core():
        key_obj = {
                "table_name": "pas_beguenst",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_beguenst.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_beguenst",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_beguenst_id","fields":["beguenstid","lvid"]},
								"sid":{"field_name":"pas_beguenst_sid","fields":["bearbidabg","beguenstid","lvid","process_id"]}
                },
