...
def load_bpms_bem_generic_type():
	key_obj = {"application_name": "DWH",
		"source_database" : "raw_zone",
		"source_table" : "bpms_bem_l0_dwh_in_1",
		"target_database" : "core",
		"target_table" : "bpms_bem_generic_type",
		"target_key_table" : "key_bpms_bem_generic_type",
		"tenant_name": "@@@TENANT@@@",
		"source_system" : "201",
		"join_tables" : [@@@TABLE_JOINS@@@],
		"message_filter" : "{'ID', 'STATUS', 'TYPE', 'VALUE'}",
		"primaryKeys": { "id":{"field_name":"bem_generic_id","fields":["id"]}, "sid":{"field_name":"bpms_bem_generic_type_sid","fields":["id","jms_message_id","process_id"]} },
		"foreignKeys": { "bpms_bem_business_event_id":["business_event_id"],"bpms_bem_complaint_id":["complaint_id"],"bpms_bem_complaint_relation_id":["source_id","target_id"],"bpms_bem_e2e_process_id":["e2e_process_id"],"bpms_bem_e2e_process_timeslot_id":["e2e_process_timeslot_id"],"bpms_bem_external_key_id":["external_key_id"],"bpms_bem_package_entry_id":["external_correlation_id","package_entry_id"],"bpms_bem_processing_goal_id":["processing_goal_id"],"bpms_bem_process_instance_id":["process_instance_id"],"bpms_document_id":["general_document_id"],"bpms_document_id":["general_document_id"] }
	}
	spark = spark_init()
