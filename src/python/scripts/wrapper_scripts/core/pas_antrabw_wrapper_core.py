...
def pas_antrabw_wrapper_core():
        key_obj = {
                "table_name": "pas_antrabw",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_antrabw.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_antrabw",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_antrabw_id","fields":["antrabwid","lvid"]},
								"sid":{"field_name":"pas_antrabw_sid","fields":["antrabwid","bearbidabg","lvid","process_id"]}
                },
