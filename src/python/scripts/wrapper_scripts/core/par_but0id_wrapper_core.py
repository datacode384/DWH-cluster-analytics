...
def par_but0id_wrapper_core():
        key_obj = {
                "table_name": "par_but0id",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/par_but0id.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_par_but0id",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"par_but0id_id","fields":["client","partner","type"]},
								"sid":{"field_name":"par_but0id_sid","fields":["client","partner","process_id","type"]}
                },
                "foreignKeys": {},
