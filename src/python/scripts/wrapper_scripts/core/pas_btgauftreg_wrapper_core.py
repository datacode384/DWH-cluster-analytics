...
def pas_btgauftreg_wrapper_core():
        key_obj = {
                "table_name": "pas_btgauftreg",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_btgauftreg.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_btgauftreg",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_btgauftreg_id","fields":["fintyp","hvgruppeid","lvid"]},
								"sid":{"field_name":"pas_btgauftreg_sid","fields":["bearbidabg","fintyp","hvgruppeid","lvid","process_id"]}
                },
