...
def pas_drittrecht_wrapper_core():
        key_obj = {
                "table_name": "pas_drittrecht",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_drittrecht.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_drittrecht",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_drittrecht_id","fields":["drittid","lvid","partnerid","rollenid"]},
								"sid":{"field_name":"pas_drittrecht_sid","fields":["bearbidabg","drittid","lvid","partnerid","process_id","rollenid"]}
                },
                "foreignKeys": {"pas_vp_id":["lvid","partnerid","rollenid"]},
