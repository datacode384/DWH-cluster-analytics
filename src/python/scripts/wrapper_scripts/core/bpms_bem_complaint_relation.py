...
def load_bpms_bem_complaint_relation():
	key_obj = {"application_name": "DWH",
		"source_database" : "raw_zone",
		"source_table" : "bpms_bem_l0_dwh_in_1",
		"target_database" : "core",
		"target_table" : "bpms_bem_complaint_relation",
		"target_key_table" : "key_bpms_bem_complaint_relation",
		"tenant_name": "",
		"source_system" : "201",
		"join_tables" : [],
		"message_filter" : "{'GENERAL_RELATION_ID', 'RELATION_TYPE_ID', 'SOURCE_ID', 'TARGET_ID'}",
		"primaryKeys": { "id":{"field_name":"bpms_bem_complaint_relation_id","fields":["source_id","target_id"]}, "sid":{"field_name":"bpms_bem_complaint_relation_sid","fields":["jms_message_id","process_id","source_id","target_id"]} },
		"foreignKeys": { }
	}
	spark = spark_init()
...
if __name__ == "__main__":
	load_bpms_bem_complaint_relation()
