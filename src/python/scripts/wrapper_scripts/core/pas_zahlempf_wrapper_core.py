...
def pas_zahlempf_wrapper_core():
        key_obj = {
                "table_name": "pas_zahlempf",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_zahlempf.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_zahlempf",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_zahlempf_id","fields":["lvid","zahlempfid"]},
								"sid":{"field_name":"pas_zahlempf_sid","fields":["bearbid","lvid","process_id","zahlempfid"]}
                },
