...
def pas_steuwertekum_wrapper_core():
        key_obj = {
                "table_name": "pas_steuwertekum",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_steuwertekum.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_steuwertekum",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_steuschicht_id","fields":["lvid","schichtid","vtid"]},
								"sid":{"field_name":"pas_steuwertekum_sid","fields":["bearbidabg","lvid","process_id","schichtid","vtid"]}
                },
                "foreignKeys": {"pas_steuschicht_id":["lvid","schichtid","vtid"]},
