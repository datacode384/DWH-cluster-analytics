...
def pas_vertschl_wrapper_core():
        key_obj = {
                "table_name": "pas_vertschl",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_vertschl.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_vertschl",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_vertschl_id","fields":["fondsid","kzwertsicher","lvid","portfid"]},
								"sid":{"field_name":"pas_vertschl_sid","fields":["bearbidabg","fondsid","investtype","kzwertsicher","lvid","portfid","process_id"]}
                },
