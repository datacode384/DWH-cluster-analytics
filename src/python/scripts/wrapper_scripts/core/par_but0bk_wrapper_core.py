...
def par_but0bk_wrapper_core():
        key_obj = {
                "table_name": "par_but0bk",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/par_but0bk.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_par_but0bk",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"par_but0bk_id","fields":["mandt","partner"]},
								"sid":{"field_name":"par_but0bk_sid","fields":["mandt","partner","process_id"]}
                },
                "foreignKeys": {},
