...
def pas_poldarl_wrapper_core():
        key_obj = {
                "table_name": "pas_poldarl",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_poldarl.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_poldarl",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_lv_id","fields":["lvid"]},
								"sid":{"field_name":"pas_poldarl_sid","fields":["bearbidabg","lvid","process_id"]}
                },
