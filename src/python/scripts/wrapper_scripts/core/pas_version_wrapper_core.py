...
def pas_version_wrapper_core():
        key_obj = {
                "table_name": "pas_version",
                "tenant_name": "r1i5v1",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_version.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_version",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"version_id","fields":["def_data_date"]},
								"sid":{"field_name":"version_sid","fields":["def_data_date","process_id"]}
                },
                "foreignKeys": {},
                "join_tables": []
        }
