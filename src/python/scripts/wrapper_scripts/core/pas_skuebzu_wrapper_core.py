...
def pas_skuebzu_wrapper_core():
        key_obj = {
                "table_name": "pas_skuebzu",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_skuebzu.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_skuebzu",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_skuebzu_id","fields":["lvid","vbid","vtid","zutsys"]},
								"sid":{"field_name":"pas_skuebzu_sid","fields":["bearbidabg","lvid","process_id","vbid","vtid","zutsys"]}
                },
