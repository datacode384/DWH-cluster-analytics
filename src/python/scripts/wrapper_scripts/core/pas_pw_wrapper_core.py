...
def pas_pw_wrapper_core():
        key_obj = {
                "table_name": "pas_pw",
                "tenant_name": "r1i5v1",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_pw.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_pw",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pw_id","fields":["productnew","productold","tariffnew","tariffold"]},
								"sid":{"field_name":"pw_sid","fields":["process_id","productnew","productold","tariffnew","tariffold"]}
                },
                "foreignKeys": {},
                "join_tables": []
        }
