...
def pas_enum_wrapper_core():
        key_obj = {
                "table_name": "pas_enum",
                "tenant_name": "r1i5v1",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_enum.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_enum",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"enum_id","fields":["enum","value"]},
								"sid":{"field_name":"enum_sid","fields":["enum","process_id","value"]}
                },
                "foreignKeys": {},
                "join_tables": []
        }
