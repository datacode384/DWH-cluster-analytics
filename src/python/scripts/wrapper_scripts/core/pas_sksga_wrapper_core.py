...
def pas_sksga_wrapper_core():
        key_obj = {
                "table_name": "pas_sksga",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_sksga.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_sksga",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_sksga_id","fields":["konspartid","lvid","vbid","vtid"]},
								"sid":{"field_name":"pas_sksga_sid","fields":["bearbidabg","konspartid","lvid","process_id","vbid","vtid"]}
                },
