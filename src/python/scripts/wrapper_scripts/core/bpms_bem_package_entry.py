...
def load_bpms_bem_package_entry():
	key_obj = {"application_name": "DWH",
		"source_database" : "raw_zone",
		"source_table" : "bpms_bem_l0_dwh_in_1",
		"target_database" : "core",
		"target_table" : "bpms_bem_package_entry",
		"target_key_table" : "key_bpms_bem_package_entry",
		"tenant_name": "",
		"source_system" : "201",
		"join_tables" : [],
		"message_filter" : "{'PACKAGE_ENTRY_ID', 'PACKAGE_ID', 'SENDER_ID'}",
		"primaryKeys": { "id":{"field_name":"bpms_bem_package_entry_id","fields":["external_correlation_id","package_entry_id"]}, "sid":{"field_name":"bpms_bem_package_entry_sid","fields":["external_correlation_id","jms_message_id","package_entry_id","process_id"]} },
		"foreignKeys": { "bpms_bem_package_id":["external_package_correlation_id","package_id"] }
	}
	spark = spark_init()
