...
def load_bpms_bem_external_key():
	key_obj = {"application_name": "DWH",
		...
		"source_system" : "201",
		"join_tables" : [],
		"message_filter" : "{'ARCHIVE_DOCUMENT_ID' ,'BUSINESS_EVENT_ID' ,'EXTERNAL_KEY_ID' ,'EXTERNAL_KEY_TYPE' ,'EXTERNAL_KEY_VALUE' ,'GENERAL_DOCUMENT_ID' ,'PACKAGE_ENTRY_ID'}",
		"primaryKeys": { "id":{"field_name":"bpms_bem_external_key_id","fields":["external_key_id"]}, "sid":{"field_name":"bpms_bem_external_key_sid","fields":["external_key_id","jms_message_id","process_id"]} },
		"foreignKeys": { "bpms_bem_business_event_id":["business_event_id"],"bpms_bem_package_entry_id":["external_correlation_id","package_entry_id"],"bpms_bem_package_entry_id":["external_correlation_id","package_entry_id"],"bpms_bem_package_entry_id":["external_correlation_id","package_entry_id"],"bpms_bem_package_entry_id":["external_correlation_id","package_entry_id"] }
	}
	spark = spark_init()
