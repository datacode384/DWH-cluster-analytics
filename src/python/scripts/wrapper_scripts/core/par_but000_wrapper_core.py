...
def par_but000_wrapper_core():
        key_obj = {
                "table_name": "par_but000",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/par_but000.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_par_but000",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"par_but000_id","fields":["client","partner"]},
								"sid":{"field_name":"par_but000_sid","fields":["client","partner","process_id"]}
                },
                "foreignKeys": {},
