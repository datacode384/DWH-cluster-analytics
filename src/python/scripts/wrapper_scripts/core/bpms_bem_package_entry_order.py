...
def load_bpms_bem_package_entry_order():
	key_obj = {"application_name": "DWH",
		"source_database" : "raw_zone",
		"source_table" : "bpms_bem_l0_dwh_in_1",
		"target_database" : "core",
		"target_table" : "bpms_bem_package_entry_order",
		"target_key_table" : "key_bpms_bem_package_entry_order",
		"tenant_name": "@@@TENANT@@@",
		"source_system" : "201",
		"join_tables" : [@@@TABLE_JOINS@@@],
		"message_filter" : "{'ORDER_TYPE'}",
...
if __name__ == "__main__":
	load_bpms_bem_package_entry_order()
