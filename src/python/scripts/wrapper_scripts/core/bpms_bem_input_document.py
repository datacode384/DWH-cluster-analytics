...
def load_bpms_bem_input_document():
	key_obj = {"application_name": "DWH",
		"source_database" : "raw_zone",
		"source_table" : "bpms_bem_l0_dwh_in_1",
		"target_database" : "core",
		"target_table" : "bpms_bem_input_document",
		"target_key_table" : "key_bpms_bem_input_document",
		"tenant_name": "",
		"source_system" : "201",
		"join_tables" : [],
		"message_filter" : "{'GENERAL_DOCUMENT_ID', 'INPUT_DOCUMENT_TYPE'}",
		"primaryKeys": { "id":{"field_name":"bpms_document_id","fields":["general_document_id"]}, "sid":{"field_name":"bpms_bem_input_document_sid","fields":["general_document_id","jms_message_id","process_id"]} },
		"foreignKeys": { "bpms_bem_package_entry_id":["external_correlation_id","package_entry_id"],"bpms_bem_package_entry_id":["external_correlation_id","package_entry_id"],"bpms_bem_package_entry_id":["external_correlation_id","package_entry_id"],"bpms_bem_package_entry_id":["external_correlation_id","package_entry_id"] }
	}
	spark = spark_init()
