...
def load_bpms_bem_process_step_activity():
	key_obj = {"application_name": "DWH",
		"source_database" : "raw_zone",
		"source_table" : "bpms_bem_l0_dwh_in_1",
		"target_database" : "core",
		"target_table" : "bpms_bem_process_step_activity",
		"target_key_table" : "key_bpms_bem_process_step_activity",
		"tenant_name": "",
		"source_system" : "201",
		"join_tables" : [],
		"message_filter" : "{'ACTIVITY_STATUS' ,'ACTIVITY_TYPE'}",
		"primaryKeys": { "id":{"field_name":"bpms_bem_process_step_id","fields":["general_process_step_id"]}, "sid":{"field_name":"bpms_bem_process_step_sid","fields":["general_process_step_id","jms_message_id","process_id"]} },
		"foreignKeys": { }
	}
	spark = spark_init()
...
if __name__ == "__main__":
	load_bpms_bem_process_step_activity()
