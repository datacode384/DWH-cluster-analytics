...
def pas_eaklausel_wrapper_core():
        key_obj = {
                "table_name": "pas_eaklausel",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_eaklausel.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_eaklausel",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_eaklausel_id","fields":["lfdnr","lvid","partnerid","rollenid","vtid"]},
								"sid":{"field_name":"pas_eaklausel_sid","fields":["bearbidabg","lfdnr","lvid","partnerid","process_id","rollenid","vtid"]}
                },
                "foreignKeys": {},
