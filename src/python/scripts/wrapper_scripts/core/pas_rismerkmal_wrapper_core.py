...
def pas_rismerkmal_wrapper_core():
        key_obj = {
                "table_name": "pas_rismerkmal",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_rismerkmal.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_rismerkmal",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_rismerkmal_id","fields":["lvid","partnerid","rismerkmalid","rollenid","vtid"]},
								"sid":{"field_name":"pas_rismerkmal_sid","fields":["bearbidabg","lvid","partnerid","process_id","rismerkmalid","rollenid","vtid"]}
                },
                "foreignKeys": {"pas_vpvt_id":["lvid","partnerid","rollenid","vtid"]},
