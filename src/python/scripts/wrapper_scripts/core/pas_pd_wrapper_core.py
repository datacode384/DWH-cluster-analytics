...
def pas_pd_wrapper_core():
        key_obj = {
                "table_name": "pas_pd",
                "tenant_name": "r1i5v1",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_pd.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_pd",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pd_id","fields":["productid"]},
								"sid":{"field_name":"pd_sid","fields":["process_id","productid"]}
                },
                "foreignKeys": {},
                "join_tables": []
        }
