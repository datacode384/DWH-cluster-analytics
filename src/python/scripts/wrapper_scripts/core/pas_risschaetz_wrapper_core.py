...
def pas_risschaetz_wrapper_core():
        key_obj = {
                "table_name": "pas_risschaetz",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_risschaetz.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_risschaetz",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_vpvt_id","fields":["lvid","partnerid","rollenid","vtid"]},
								"sid":{"field_name":"pas_risschaetz_sid","fields":["bearbidabg","lvid","partnerid","process_id","rollenid","vtid"]}
                },
