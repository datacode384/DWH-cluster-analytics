...
def pas_sbquotausgl_wrapper_core():
        key_obj = {
                "table_name": "pas_sbquotausgl",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_sbquotausgl.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_sbquotausgl",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_sbquotausgl_id","fields":["konspartid","lvid","sbid","varianteid","vtid"]},
								"sid":{"field_name":"pas_sbquotausgl_sid","fields":["bearbid","konspartid","lvid","process_id","sbid","varianteid","vtid"]}
                },
