...
def par_tiban_wrapper_core():
        key_obj = {
                "table_name": "par_tiban",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/par_tiban.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_par_tiban",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"par_tiban_id","fields":["bankl","bankn","banks","mandt"]},
								"sid":{"field_name":"par_tiban_sid","fields":["bankl","bankn","banks","mandt","process_id"]}
                },
                "foreignKeys": {},
