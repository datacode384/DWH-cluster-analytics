...
def pas_jurvt_wrapper_core():
        key_obj = {
                "table_name": "pas_jurvt",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_jurvt.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_jurvt",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_jurvt_id","fields":["lvid","vtid"]},
								"sid":{"field_name":"pas_jurvt_sid","fields":["bearbidabg","lvid","process_id","vtid"]}
                },
