...
def pas_sbuebverw_wrapper_core():
        key_obj = {
                "table_name": "pas_sbuebverw",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_sbuebverw.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_sbuebverw",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_sbuebverw_id","fields":["lvid","sbid","varianteid","vsys","vtid"]},
								"sid":{"field_name":"pas_sbuebverw_sid","fields":["bearbid","lvid","process_id","sbid","varianteid","vsys","vtid"]}
                },
