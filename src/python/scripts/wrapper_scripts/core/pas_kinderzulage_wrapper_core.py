...
def pas_kinderzulage_wrapper_core():
        key_obj = {
                "table_name": "pas_kinderzulage",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_kinderzulage.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_kinderzulage",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_kinderzulage_id","fields":["hvgruppeid","kindid","lvid"]},
								"sid":{"field_name":"pas_kinderzulage_sid","fields":["bearbidabg","hvgruppeid","kindid","lvid","process_id"]}
                },
