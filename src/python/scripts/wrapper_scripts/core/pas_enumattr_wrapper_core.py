...
def pas_enumattr_wrapper_core():
        key_obj = {
                "table_name": "pas_enumattr",
                "tenant_name": "r1i5v1",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_enumattr.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_enumattr",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"enumattr_id","fields":["attribute","entity"]},
								"sid":{"field_name":"enumattr_sid","fields":["attribute","entity","process_id"]}
                },
                "foreignKeys": {},
                "join_tables": []
        }
