...
def pas_sbuebzu_wrapper_core():
        key_obj = {
                "table_name": "pas_sbuebzu",
                "tenant_name": "ITERGO",
                "application_name": "DWH",
                "local_loc" : "/shared/original/pas_sbuebzu.csv",
                "hdfs_loc" : "/tmp/ingests",
                "hdfs_file_loc" : "",
                "source_system" : "201",
                "source_database" : "raw_zone",
                "target_database" : "core",
                "target_key_table" : "key_pas_sbuebzu",
                "partitions" : ["process_id"],
                "primaryKeys": { "id":{"field_name":"pas_sbuebzu_id","fields":["lvid","sbid","varianteid","vtid","zutsys"]},
								"sid":{"field_name":"pas_sbuebzu_sid","fields":["bearbid","lvid","process_id","sbid","varianteid","vtid","zutsys"]}
                },
