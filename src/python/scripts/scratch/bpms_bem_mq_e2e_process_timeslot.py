...
def process_test_mq_msg_filter():
	...
	key_obj = {"application_name": "DWH",
		...
		"message_filter" : "{'DATE_INSERT', 'DATE_UPDATE', 'DWH_COUNTER', 'E2E_BUSINESS_EVENT_ID', 'E2E_PACKAGE_ENTRY_ID', 'E2E_PROCESS_ID', 'E2E_PROCESS_TIMESLOT_DETAILS', 'E2E_PROCESS_TIMESLOT_END', 'E2E_PROCESS_TIMESLOT_ID', 'E2E_PROCESS_TIMESLOT_RESULT', 'E2E_PROCESS_TIMESLOT_START', 'E2E_PROCESS_TIMESLOT_STATUS_ID', 'INPUT_CHANEL_ID', 'VERSION'}",
		"primaryKeys": {},
		"foreignKeys": {}
	}
