...
def process_test_mq_msg_filter():
	...
	key_obj = {"application_name": "DWH",
		...
		"message_filter" : "{'DWH_COUNTER', 'ENVELOPE_ID', 'GENERAL_DOCUMENT_ID', 'IMS_ID', 'INPUT_CHANEL_ID', 'INPUT_DOCUMENT_TYPE_ID', 'PROCESSING_TIMESTAMP', 'RECEIVE_TIMESTAMP', 'RETURNED_DOCUMENT_ID', 'SCAN_TIMESTAMP', 'SENDER_ID'}",
		"primaryKeys": {},
		"foreignKeys": {}
	}
