...
def process_test_mq_msg_filter():
	...
	key_obj = {"application_name": "DWH",
		...
		"message_filter" : "{'CREATION_TIMESTAMP', 'DATE_INSERT', 'DATE_UPDATE', 'DWH_COUNTER', 'E2E_PROCESS_TIMESLOT_ID', 'GENERAL_PROCESS_STEP_ID', 'ORIGINATOR', 'PROCESSING_GOAL_ID', 'PROCESSING_GOAL_STATUS_ID', 'PROCESSING_GOAL_TYPE_ID', 'VERSION'}",
		"primaryKeys": {},
		"foreignKeys": {}
	}
