...
def process_test_mq_msg_filter():
	...
	key_obj = {"application_name": "DWH",
		...
		"message_filter" : "{'COMPLETION_TIMESTAMP', 'CREATION_TIMESTAMP', 'DATE_INSERT', 'DATE_UPDATE', 'DWH_COUNTER', 'EXTERNAL_PACKAGE_CORRELATION_ID', 'FETCH_TIMESTAMP', 'PACKAGE_ID', 'PACKAGE_STATUS_ID', 'PACKAGE_TYPE_ID', 'RECEIVE_TIMESTAMP', 'SEND_TIMESTAMP', 'STACK_ID', 'VERSION'}",
		"primaryKeys": {},
		"foreignKeys": {}
	}
