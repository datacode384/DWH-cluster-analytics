...
def process_test_mq_msg_filter():
	...
	key_obj = {"application_name": "DWH",
		...
		"message_filter" : "{'DATE_INSERT', 'DATE_UPDATE', 'DTYPE', 'DWH_COUNTER', 'EXTERNAL_CORRELATION_ID', 'PACKAGE_ENTRY_ID', 'PACKAGE_ENTRY_STATUS_ID', 'PACKAGE_ENTRY_TYPE_ID', 'PACKAGE_ID', 'VERSION'}",
		"primaryKeys": {},
		"foreignKeys": {}
	}
