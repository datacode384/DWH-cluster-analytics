...
def process_test_mq_msg_filter():
	...
	key_obj = {"application_name": "DWH",
		...
		"message_filter" : "{'BUSINESS_EVENT_ID', 'DATE_INSERT', 'DATE_UPDATE', 'DWH_COUNTER', 'E2E_PROCESS_TIMESLOT_ID', 'PROCESSING_MODE_ID', 'PROCESS_INSTANCE_COMPLETION_TIMESTAMP', 'PROCESS_INSTANCE_EXTERNAL_ID', 'PROCESS_INSTANCE_ID', 'PROCESS_INSTANCE_INIT_TIMESTAMP', 'PROCESS_INSTANCE_PARENT_ID', 'PROCESS_INSTANCE_STATUS_ID', 'PROCESS_INSTANCE_TYPE_ID', 'VERSION'}",
		"primaryKeys": {},
		"foreignKeys": {}
	}
