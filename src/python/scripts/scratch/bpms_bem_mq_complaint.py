...
def process_test_mq_msg_filter():
	...
	key_obj = {"application_name": "DWH",
		...
		"message_filter" : "{'BUSINESS_EVENT_ID', 'COMPLAINT_EXTERNAL_REFERENCE', 'COMPLAINT_HCM_TYPE_ID', 'COMPLAINT_ID', 'COMPLAINT_INITIATOR_TYPE_ID', 'COMPLAINT_INIT_TIMESTAMP', 'COMPLAINT_NOTE', 'COMPLAINT_OWNER_TYPE_ID', 'COMPLAINT_STATUS_ID', 'COMPLAINT_SUCCESS', 'COMPLAINT_TOP_FLAG', 'COMPLAINT_TYPE_ID', 'COMPLAINT_VALUE', 'COMPLAINT_VARIANT_TYPE_ID', 'DATE_INSERT', 'DATE_UPDATE', 'REASON_DETAILS_TYPE_ID', 'REASON_TYPE_ID', 'SUCCESS_EVALUATION_TYPE_ID', 'VERSION'}",
		"primaryKeys": {},
		"foreignKeys": {}
	}
