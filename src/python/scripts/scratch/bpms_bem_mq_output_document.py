...
def process_test_mq_msg_filter():
	...
	key_obj = {"application_name": "DWH",
		...
		"message_filter" : "{'BUSINESS_EVENT_ID', 'E2E_TIMESLOT_ID', 'GENERAL_DOCUMENT_ID', 'GENERATION_TIMESTAMP', 'OUTPUT_CHANEL_ID', 'OUTPUT_DOCUMENT_STATUS_ID', 'OUTPUT_DOCUMENT_TYPE_ID', 'PRINT_TIMESTAMP', 'RECEIVER_ID', 'SEND_TIMESTAMP'}",
		"primaryKeys": {},
		"foreignKeys": {}
	}
