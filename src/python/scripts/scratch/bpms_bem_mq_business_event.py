...
def process_test_mq_msg_filter():
	...
	key_obj = {"application_name": "DWH",
		...
		"message_filter" : "{'BE_REASON_STATUS_ID', 'BUSINESS_EVENT_ID', 'BUSINESS_EVENT_STATUS_ID', 'BUSINESS_EVENT_TYPE_ID', 'COMPLETION_TIMESTAMP', 'DATE_INSERT', 'DATE_UPDATE', 'DTYPE', 'DUE_DATE', 'DWH_COUNTER', 'E2E_PROCESS_ID', 'GEVO_ID', 'INIT_TIMESTAMP', 'INPUT_CHANEL_ID', 'ORIGINATOR_BP_ID', 'REVOCATION_DEADLINE', 'STATUS_DETAILS', 'VERSION'}",
		"primaryKeys": {},
		"foreignKeys": {}
	}
